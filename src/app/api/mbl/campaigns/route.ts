  ...
  try {
    ...
    const { data: campaign, error: createError } = await admin
      ...
      .insert({
        ...
        criteria_lot_sqft_min: data.criteria.lot_sqft_min ?? null,
        criteria_lot_sqft_max: data.criteria.lot_sqft_max ?? null,
        criteria_property_type: data.criteria.property_type ?? null,
        criteria_neighborhoods: data.criteria.neighborhoods ?? [],
