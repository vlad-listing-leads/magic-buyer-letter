...
// =============================================================================
// Skills (Admin-configurable letter styles)
// =============================================================================

/** Admin-managed skill for letter generation */
export interface MblSkill {
  id: string
  name: string
  description: string
...
/** Letter template generated by Claude for a skill */
